...
module.exports.get_map_position = get_map_position;
module.exports.convertStorage = convertStorage;
module.exports.print_option_values = print_option_values;
module.exports.map_set = map_set;
